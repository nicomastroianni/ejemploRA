...
public class AT_Put {
			...
			public static RetornoDeTelefono AP_PutTelefono(String URLDinamic, String canal,String usuario,Telefono telefono,int idTelefono, int idPersona,String UUID){ 
				String url=URLDinamic+"/"+idPersona+"/telefonos/"+idTelefono;
				Log.logloggerIID_debug(UUID+";Java;AT_Put;"+"URL: "+url);
				RetornoDeTelefono retorno = new RetornoDeTelefono();
				
				
				System.out.println("Inicio: AT_PutTelefono");
		        ...
		        try{
		            ...
		            Log.logloggerIID_debug(UUID+";Java;AT_Put;"+"Request: "+telefonoJson);
		            ...
		            switch(responseCode) {
		            	...
		            	case 200:
		                	...
		                	Gson telefonoJSON = new Gson();
		                	telefono = telefonoJSON.fromJson(respuesta, Telefono.class);
		                	Log.logloggerIID_debug(UUID+";Java;AT_Put;"+"Respuesta: "+respuesta);
