...
public class AD_Put {
		...
		public static RetornoDeDomicilios AP_PutDomicilio(String urlDinamic,String canal,String usuario,Domicilio domicilio, String idPersona,String UUID){ 
			String url=urlDinamic+"/"+idPersona+"/domicilios/"+domicilio.getId();
			Log.logloggerIID_debug(UUID+";Java;AD_Put;"+"URL: "+url);
			RetornoDeDomicilios retorno = new RetornoDeDomicilios();
			
			
			System.out.println("Inicio: AP_PutDomicilio");
	        ...
	        try{
	            ...
	            Gson gson = new Gson();
	            String domicilioJson = gson.toJson(domicilio);//(sb.toString(), persona.class);
	            
	            osw.write(domicilioJson);
	            osw.flush();
	            osw.close();
	            ...
	            switch(responseCode) {
	            	...
	            	case 200:
	                	...
	                	Gson domicilioJSON = new Gson();
	                	domicilio = domicilioJSON.fromJson(respuesta, Domicilio.class);
	        			Log.logloggerIID_debug(UUID+";Java;AD_Put;"+"Respuesta: "+respuesta);
